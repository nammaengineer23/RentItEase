...
class UploadImagesPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<UploadImagesPage> createState() =>
      _UploadImagesPageState();
}

class _UploadImagesPageState
    extends ConsumerState<UploadImagesPage> {
  ...
  Future<void> _uploadImages() async {
    ...
    if (state.error == null &&
        state.uploadedImages.isNotEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
