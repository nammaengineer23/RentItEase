...
export interface SocialProperty { id: string; title: string; city: string; locality?: string | null; createdAt: string; owner: { id: string; fullName: string }; socialMarketingConsent: { id: string; approved: boolean; consentVersion: string; consentedAt: string; preparedVideoUrl?: string | null; preparedCaption?: string | null; preparedTitle?: string | null; preparedAt?: string | null }; images: Array<{ id: string; imageUrl: string }>; }
